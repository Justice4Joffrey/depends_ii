...
use std::cell::Ref;
use depends_derives::Value;

use crate::{DepRef, DepRef2, DepRef3, Identifiable, NodeState, UpdateDerived, UpdateInput, Visitor};
...
/// #     InputNode, NodeHash, Resolve, SingleRef, TargetMut, UpdateDerived, UpdateInput,
/// # };
...
///   node_0 -> node_6 [label="Sum"];
///   node_1 -> node_6 [label="Sum"];
///   node_7 [label="NumberValueI32"];
///   node_3 -> node_7 [label="Multiply"];
///   node_4 -> node_7 [label="Multiply"];
///   node_8 [label="NumberValueI32"];
///   node_0 -> node_8 [label="Sum"];
///   node_7 -> node_8 [label="Sum"];
///   node_9 [label="NumberValueI32"];
///   node_5 -> node_9 [label="Sum"];
///   node_6 -> node_9 [label="Sum"];
///   node_8 -> node_9 [label="Sum"];
/// }
/// "#
///     .trim()
/// );

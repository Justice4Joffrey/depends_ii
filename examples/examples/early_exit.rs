...
impl UpdateDerived<SingleRef<'_, OpenOrders>, CheckRiskLimit> for RiskLimit {
    fn update(&mut self, value: SingleRef<'_, OpenOrders>) -> Result<(), EarlyExit> {
...
impl UpdateDerived<SingleRef<'_, OpenOrders>, CalculateNextNumber> for ExpensiveCalculation {
    fn update(&mut self, _: SingleRef<'_, OpenOrders>) -> Result<(), EarlyExit> {

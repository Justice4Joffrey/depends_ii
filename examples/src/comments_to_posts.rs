use depends::{
    ...
    error::EarlyExit,
    SingleRef, TargetMut, UpdateDerived, UpdateTarget,
};
...
impl<'a> UpdateTarget<SingleRef<'a, Comments>> for CommentsToPosts {
    fn update_mut(&mut self, comments: SingleRef<'a, Comments>) -> Result<(), EarlyExit> {

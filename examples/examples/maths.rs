...
use depends::{derives::{Dependencies, Operation, Value}, error::EarlyExit, graphviz::GraphvizVisitor, Dependency, DerivedNode, InputNode, Resolve, SingleRef, TargetMut, UpdateDerived, UpdateInput, DepRef2, DepRef3, DepRef, Dependencies2, Dependencies3};
...
pub struct Square;
impl<A> UpdateDerived<DepRef<'_, A>, Square> for NumberValueI32 {
